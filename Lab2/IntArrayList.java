...
/**
 * Public class IntArrayList defines an array list, similar to the in-built array List claass in Java. The class is defining
 * the methods, namely add(int e), add(int index, int e), get(int index), clear(), isEmpty(), remove(int index), size(),
 * arraySize(), empty_cnt, toString(), and next().
 *
...
public class IntArrayList
{
    ...
    public IntArrayList()
    {
        this.arrayList = new int[DEFAULT_CAP];
        this.size = 0;
    }
    ...
    public void add (int index, int e){
        ...
        //While placing an index in an index that is already filled, create space, and adjust the elements
            ...
            //If the list is already full, expand the size by 10
                ...
                int[] newArrayList = new int[arrayList.length + 10];
    ...
    public int remove(int index){
        ...
        //else remove that element and adjust other elements
            ...
            int storedValue = arrayList[index];
            //element removed
            arrayList = newArray;
            size--;
